    ...
    <div className='relative w-full h-auto'>
      ...
      <main className='relative flex flex-col md:flex-row justify-between items-start w-full h-auto'>
        <section className='bg-gray-200 w-full md:w-1/5 md:mr-1'>
          <ul className='relative w-full flex flex-row flex-wrap md:flex-col justify-center items-center p-1'>
            <Link href="#" className='relative basis-2/5 md:basis-2/5 h-8 m-1'>
              <li className='relative w-full h-full flex justify- items-center flex-nowrap border border-black rounded-md overflow-hidden bg-blue-100'>
                  <div className='relative w-1/3'>
                    <Image src="/z_cat1.jpg" layout="responsive" className='w-full object-cover' width={50} height={35}/>
                  </div>
                  <p className='relative w-2/3 text-center'>Electronics</p>
              </li>
            </Link>
            <Link href="#" className='relative basis-2/5 md:basis-1/3 h-8 m-1'>
              <li className='relative w-full h-full flex justify- items-center flex-nowrap border border-black rounded-md overflow-hidden bg-blue-100'>
                  <div className='relative w-1/3'>
                    <Image src="/z_cat2.jpg" layout="responsive" className='w-full object-cover' width={50} height={35}/>
                  </div>
            ...
            <Link href="#" className='relative basis-2/5 md:w-full h-8 m-1'>
              <li className='relative w-full h-full flex justify- items-center flex-nowrap border border-black rounded-md overflow-hidden bg-blue-100'>
                  <div className='relative w-1/3'>
                    <Image src="/z_cat3.jpg" layout="responsive" className='w-full object-cover' width={50} height={35}/>
                  </div>
